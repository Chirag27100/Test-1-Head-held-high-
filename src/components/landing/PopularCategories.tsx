...
const questionCards = [
  ...
  {
    question: 'Want to arrange an industrial or factory visit?',
    answer: 'Coordinate visits with HOC in-house specialists',
  ...
  {
    question: 'Looking for legal documentation or compliance support?',
    answer: 'Connect with para-legal experts',
    link: '/services/Para Legal Assistance',
    gradient: 'from-slate-600 to-gray-700',
  },
  {
    question: 'Need pet care, grooming or vet services?',
    answer: 'Explore HOC pet industry solutions',
    link: '/services/pet-industry',
