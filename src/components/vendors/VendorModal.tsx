          ...
          <div className="flex flex-col sm:flex-row gap-3">
            {service && (
              <Link
                ...
                onClick={onClose}
                className="flex-1 text-center px-5 py-3 bg-gray-50 border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:border-teal-500/60 hover:text-teal-600 hover:bg-teal-50/30 transition-all text-sm"
              >
