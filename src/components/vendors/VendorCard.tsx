...
import { Star, MapPin, Award, Briefcase, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="group relative bg-gradient-to-br from-white to-gray-50/50 rounded-2xl border border-gray-200/60 overflow-hidden hover:shadow-2xl hover:border-teal-300/60 transition-all duration-300 hover:-translate-y-2">
      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex gap-2">
          <Link
            to={`/services/${vendor.category}`}
            className="flex-1 text-center px-4 py-2.5 bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200/60 text-gray-700 font-semibold rounded-xl hover:border-teal-500/60 hover:text-teal-600 hover:bg-teal-50/30 transition-all text-sm group"
          >
            View Service
          </Link>
          <Link
