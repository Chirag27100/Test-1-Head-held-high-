          ...
          {vendors.map((vendor) => {
            ...
            return (
              <div
                ...
                className="group relative bg-gradient-to-br from-white to-gray-50/50 rounded-2xl border border-gray-200/60 overflow-hidden hover:shadow-2xl hover:border-teal-300/60 transition-all duration-300 sm:hover:-translate-y-2 active:scale-[0.99] cursor-pointer"
              >
