...
const GROQ_KEY = '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';
...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: "Hi! 👋 I'm the Head Held High assistant. How can I help you today?" }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages(p => [...p, { role: 'assistant', content: 'Something went wrong. Please try again or email hello@headheldhigh.com' }]);
        ...
        <div className="w-[360px] h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-teal-600 to-cyan-600 px-4 py-3.5 flex items-center justify-between flex-shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-white font-semibold text-sm">Head Held High Assistant</p>
