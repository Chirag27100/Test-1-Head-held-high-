...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: "Hi, I'm VELA — your Head Held High assistant. What can I help you with today?" }
  ]);
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-end gap-3" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        ...
        <div className="w-[calc(100vw-32px)] sm:w-[360px] max-w-[360px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden" style={{ height: 'min(500px, calc(100dvh - 100px))' }}>
          ...
          <div className="bg-gradient-to-r from-teal-600 to-cyan-600 px-4 py-3.5 flex items-center justify-between flex-shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-white font-semibold text-sm">VELA — HOC Assistant</p>
      ...
      {showBubble && !isOpen && (
        <div className="animate-bounce-gentle hidden sm:block">
