...
export default function Footer() {
  const firstHalf = services.slice(0, 5);
  const secondHalf = services.slice(5);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:hello@headheldhigh.com" className="flex items-center gap-2 text-sm text-gray-400 hover:text-teal-400 hover:translate-x-1 transition-all group">
                ...
                hello@headheldhigh.com
              </a>
              <a href="tel:+1234567890" className="flex items-center gap-2 text-sm text-gray-400 hover:text-teal-400 hover:translate-x-1 transition-all group">
                <div className="w-8 h-8 bg-gradient-to-br from-teal-500/20 to-cyan-500/20 rounded-lg flex items-center justify-center group-hover:from-teal-500/40 group-hover:to-cyan-500/40 transition-all">
