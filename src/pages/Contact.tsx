...
const contactInfo = [
  { icon: Mail, label: 'Email', value: 'care@headheldhigh.in', href: 'mailto:care@headheldhigh.in' },
  { icon: Phone, label: 'Phone', value: '+91 94482 00842', href: 'tel:+919448200842' },
  { icon: MapPin, label: 'Office', value: '5th Cross Rd, Silver Oak Layout, Phase 7, J. P. Nagar, Bengaluru, Karnataka 560078' },
