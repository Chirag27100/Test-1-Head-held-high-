...
import { ArrowRight, Target, Users, Award, TrendingUp, CheckCircle, Briefcase, GraduationCap, Linkedin, Mail } from 'lucide-react';
...
export default function About() {
  ...
  const founderAchievements = [
    '18 years of industry experience across civil infrastructure, B2B vendor ecosystems, and operational consulting',
    'Founded Head Held High to resolve complex business challenges by connecting enterprises with Tier 1 specialists',
    'Built and scaled a B2B multi-vendor platform across 10+ service categories with end-to-end delivery accountability',
    'Established a network of 500+ verified Tier 1 vendor partnerships spanning 15+ cities across India',
    'Developed proprietary specialist vetting, quality assurance, and client outcome tracking systems',
    'Led delivery of 2000+ B2B client engagements with verified satisfaction and repeat business records',
  ];
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-2xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-teal-50 text-teal-700 text-xs font-semibold rounded-full uppercase tracking-wider mb-4">
              Leadership
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Meet the Founder</h2>
          </AnimatedSection>

          <div className="max-w-5xl mx-auto">
            <AnimatedSection>
              <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-teal-950 rounded-3xl overflow-hidden shadow-2xl">
                <div className="grid grid-cols-1 lg:grid-cols-5">
                  {/* Photo + Identity */}
                  <div className="lg:col-span-2 p-8 lg:p-10 flex flex-col items-center lg:items-start text-center lg:text-left border-b lg:border-b-0 lg:border-r border-white/10">
                    <div className="relative mb-6">
                      <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center shadow-xl">
                    ...
                    <p className="text-teal-400 font-medium mb-1">Head Held High</p>
                    <p className="text-gray-400 text-sm mb-6">Bengaluru, India</p>
                    ...
                    <div className="flex gap-3 mt-6">
                      <a
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-white text-sm font-medium transition-all"
                      >
                  ...
                  <div className="lg:col-span-3 p-8 lg:p-10">
                    <div className="mb-8">
                      <h4 className="text-white font-semibold mb-3 text-sm uppercase tracking-wider text-teal-400">About</h4>
                      <div className="space-y-3 text-gray-300 text-sm leading-relaxed">
                        <p>
                          With 18 years of industry experience spanning civil infrastructure, B2B vendor ecosystems, and operational consulting, the founder established Head Held High with a singular aim: to resolve complex and planned business problems efficiently — by bringing in the right specialists to provide solutions and hands-on assistance.
                        </p>
                        <p>
                          The insight was born from years on the ground: enterprises consistently struggled to access reliable, domain-expert professionals for high-stakes engagements. The market lacked accountability, vetting standards, and end-to-end delivery ownership. Head Held High was built to close that gap — exclusively for B2B clients who need results, not referrals.
                        </p>
                        <p>
                          What began in Bengaluru has grown into a multi-city platform with 500+ verified Tier 1 vendors, a rigorous quality assurance framework, and a track record of delivering complex projects across 10+ professional service categories. The vision: build the definitive B2B specialist network for enterprises across India.
                        </p>
                      </div>
                    </div>

                    <div>
                      <h4 className="text-teal-400 font-semibold mb-3 text-sm uppercase tracking-wider">Key Achievements</h4>
                      <ul className="space-y-2">
                        {founderAchievements.map((item, i) => (
